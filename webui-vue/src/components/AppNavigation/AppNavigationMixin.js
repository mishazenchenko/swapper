...
import CloudLogging from '@carbon/icons-vue/es/cloud--logging/16';
...
const AppNavigationMixin = {
  components: {
    ...
    iconDepoHostManagement: CloudLogging,
  },
  data() {
    return {
      navigationItems: [
        ...
        {
          id: 'depo-host-management',
          label: i18n.global.t('depo.depoHostManagement'),
          route: '/depo-host-management/depo-host-boot-order',
          icon: 'iconDepoHostManagement',
        },
        {
          id: 'logs',
